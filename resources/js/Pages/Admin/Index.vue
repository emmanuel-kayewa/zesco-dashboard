<template>
  <AppLayout :directorates="directorates">
      ...
      <div class="flex flex-wrap items-center gap-6 p-2">
        <div class="flex items-center gap-3">
          ...
          <button
            ...
            :class="
              simulationActive ? 'bg-green-500' : 'bg-gray-300 dark:bg-gray-600'
            "
          >
            <span
          ...
          <span
            class="text-xs"
            :class="simulationActive ? 'text-green-600' : 'text-gray-400'"
          >
            {{ simulationActive ? "Running" : "Stopped" }}
          </span>
        </div>
        <Button
          @click="runSimulationCycle"
      ...
      >
        <div v-for="setting in settings" :key="setting.key">
          <label
            ...
            >{{ setting.label || setting.key }}</label
          >
          <input
          ...
          <input
            ...
            v-model="settingsForm[setting.key]"
            type="checkbox"
            class="rounded border-gray-300 text-[var(--palette-accent)] focus:ring-[var(--palette-accent)]"
          />
          <input
            v-else
            v-model="settingsForm[setting.key]"
    ...
    <Card title="User Management" class="mb-6">
      ...
      <DataTable
        :columns="[
          ...
          { key: 'wa_phone', label: 'WA Phone', class: 'hidden md:table-cell' },
          {
            key: 'last_login',
            label: 'Last Login',
      ...
      >
        ...
        <td class="py-2 px-3 text-gray-500 hidden sm:table-cell">
          {{ user.email }}
        </td>
        <td class="py-2 px-3">
          <select
            ...
            class="text-xs rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-gray-500 focus:border-gray-500"
          >
        ...
        <td class="py-2 px-3">
          <select
            ...
            @change="updateUserDirectorate(user)"
            class="text-xs rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-gray-500 focus:border-gray-500"
          >
        ...
        <td class="py-2 px-3">
          ...
          >
            <input
              v-model="user.whatsapp_opt_in"
              @change="updateUserWhatsApp(user)"
              type="checkbox"
              class="rounded border-gray-300 text-[var(--palette-accent)] focus:ring-[var(--palette-accent)]"
            />
            <span>Opt-in</span>
        ...
        <td class="py-2 px-3 text-gray-400 text-xs hidden md:table-cell">
    ...
    >
      ...
      ></div>
      <div
        class="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 w-full max-w-md p-6"
      >
        ...
        <form @submit.prevent="submitAddUser">
          <div class="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                required
                class="w-full text-sm px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-black dark:focus:border-white outline-none"
              >
              ...
              <p
                v-if="newUserForm.errors.role_id"
                class="text-xs text-red-500 mt-1"
              >
                {{ newUserForm.errors.role_id }}
              </p>
            </div>
            <div>
              <label
              ...
              >
              <select
                v-model="newUserForm.directorate_id"
                class="w-full text-sm px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-black dark:focus:border-white outline-none"
              >
                <option :value="null">None</option>
                <option v-for="d in directorates" :key="d.id" :value="d.id">
            ...
            <div>
              ...
              >
                <input
                  v-model="newUserForm.whatsapp_opt_in"
                  type="checkbox"
                  class="rounded border-gray-300 text-[var(--palette-accent)] focus:ring-[var(--palette-accent)]"
                />
            ...
            <div>
              ...
              >
              <input
                v-model="newUserForm.whatsapp_phone"
                type="text"
                placeholder="+260XXXXXXXXX"
                class="w-full text-sm px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-black dark:focus:border-white outline-none"
              />
              <p
                v-if="newUserForm.errors.whatsapp_phone"
                class="text-xs text-red-500 mt-1"
              >
                {{ newUserForm.errors.whatsapp_phone }}
              </p>
            </div>
          </div>
          <div
          ...
          >
            ...
            <Button
              ...
              :loading="newUserForm.processing"
              variant="primary"
              size="sm"
            >
    ...
    <Card title="Directorates" class="mb-6">
      <div
        class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 p-2"
      >
        <div
          v-for="d in allDirectorates"
          :key="d.id"
          class="p-3 border border-gray-100 dark:border-gray-700 rounded-lg"
        >
    ...
    <Card title="Audit Trail">
      <div class="p-2 flex items-center justify-between">
        <p class="text-sm text-gray-500 dark:text-gray-400">
          View all system activity and data change logs.
        </p>
        <Link href="/admin/audit-logs" class="btn-primary text-xs"
