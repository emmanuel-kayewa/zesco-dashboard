  ...
  <AppLayout>
    ...
    <div class="space-y-6">
      ...
      <div class="flex flex-col gap-2">
        <div>
          <Link
            :href="`/pp/weekly-reports/${report.id}`"
      ...
      <form @submit.prevent="submitReport" class="space-y-6">
        ...
        <div v-for="(section, si) in form.sections" :key="si" class="space-y-0">
          <Card>
            <template #title>
              <div
                class="flex flex-col gap-2 w-full sm:flex-row sm:items-center sm:gap-3 min-w-0"
              >
                <div class="flex flex-row items-center gap-2 min-w-0 w-full">
                  <span
                    class="flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white text-xs sm:text-sm font-bold flex-shrink-0 self-start sm:self-center"
                  >
                    {{ si + 1 }}
                  </span>
                  <Input
                ...
                <div
                  class="flex flex-col gap-2 w-full sm:flex-row sm:items-center sm:w-auto"
                >
