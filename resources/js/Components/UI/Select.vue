        ...
        >
          ...
          >
            <input
              ...
              type="text"
              placeholder="Search…"
              class="w-full px-2.5 py-1.5 text-sm rounded-md border border-zinc-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-zinc-700 dark:text-gray-200 placeholder-zinc-400 dark:placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-zinc-400 dark:focus:ring-gray-500"
              @keydown.stop
            />
          </div>
          ...
          <div
            ...
            class="px-3 py-2 text-sm text-zinc-400 dark:text-gray-500 italic"
          >
            No matches found
          </div>
...
const getOptionLabel = (option) => {
  if (typeof option === "object" && option !== null) {
    return (
      option[props.optionLabel] ?? option.label ?? option.name ?? option.value
    );
  }
  return option;
};
...
const selectClasses = computed(() => {
  const baseClasses =
    "relative w-full text-left appearance-none ps-3 pe-10 block rounded-lg shadow-sm border transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-gray-900";
  ...
  if (props.error) {
    stateClasses =
      "bg-red-50 border-red-500 text-red-900 cursor-pointer dark:bg-gray-800 dark:text-red-400 dark:border-red-500";
    ...
    stateClasses =
      "bg-white border-zinc-200 border-b-zinc-300/80 text-zinc-700 cursor-pointer dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200";
  }
